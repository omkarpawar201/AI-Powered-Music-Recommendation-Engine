...
class ITunesCatalogClient(
     ...
     */
    suspend fun searchArtistTopTracks(artistName: String, limit: Int = 15): List<CandidateTrack> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun searchRelatedTracks(query: String, limit: Int = 15): List<CandidateTrack> = withContext(Dispatchers.IO) {
